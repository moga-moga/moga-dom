...
var MogaButtonDom = /** @class */ (function (_super) {
    __extends(MogaButtonDom, _super);
    function MogaButtonDom(value, classes, id, name) {
    ...
    return MogaButtonDom;
}(dom_1.MogaDom));
exports.MogaButtonDom = MogaButtonDom;
